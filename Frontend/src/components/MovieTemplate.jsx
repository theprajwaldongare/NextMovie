    ...
    return (
        <>
            <div tabIndex={0} className="main m-4 w-60 relative group rounded-2xl overflow-hidden cursor-pointer shadow-lg outline-none">
                <img src={poster || 'templateImage.avif'} alt="movieImage" className='w-full h-90 object-cover transition-transform duration-300 group-hover:scale-105 group-focus:scale-105' />
